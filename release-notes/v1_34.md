...
**Visual Studio Code Remote Development** allows you to use a container, remote
machine, or the
...
Please note that in this release, it is not possible to create a `preLaunchTask`
