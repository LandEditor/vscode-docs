...
Previously, Source Control input would auto-grow to display at most 6 lines of
...
When using inline chat for fixes (`/fix`), you now also get a short summary what
