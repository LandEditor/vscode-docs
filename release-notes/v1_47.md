...
Since we haven't found a better approach, and this method can be implemented
...
The changes in TypeScript 4.0 make it possible for VS Code provide IntelliSense
