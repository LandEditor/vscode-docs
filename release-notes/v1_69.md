...
To use the same flow for `git ecommit` commands executed in the Integrated Terminal, enable the `git.terminalGitEditor` setting. After enabling the setting, you will have to restart your terminal session.
...
* [@JohnnyCrazy (Jonas Dellinger)](https://github.com/JohnnyCrazy): A full editor can be used as git ecommit message editor [PR #95266](https://github.com/microsoft/vscode/pull/95266)
