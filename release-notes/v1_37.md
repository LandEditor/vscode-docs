...
Back in the 1.29 release, we added the setting `search.usePCRE2` to make search
...
-   [@sharkykh](https://github.com/sharkykh): Put current git branch name as
    value when renaming
...
-   **Chinese Simplified:** Tingting Yi, 斌 项, paul cheung, Yiting Zhu, 建东
    薛, feiyun0112 feiyun0112, Joel Yang, 刘瑞恒 刘瑞恒, Edi Wang, Junzhe Liu,
    Dave Young, 张锐, Yizhi Gu, Fan Su, 昊宇 周, Justin Liu, Pluwen, Tony Xia,
    Yu Zhang, XIANG ZUO, 少民 谈, 彦佐 刘, Zhiqiang Li, 福永 叶, G.Y. Z, Hao Hu,
    志乐 龚, meng shao, Horie Yuan, Xiangrui Kong, Liam Kennedy, 王文杰, 赵畅畅,
