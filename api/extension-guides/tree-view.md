...
Here is an example of a `TreeDataProvider` implementation that provides node
dependencies data:
...
Now we have a command that will refresh the node dependencies view, but a button
