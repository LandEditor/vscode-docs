...
- Importing or requiring other modules is not supported. `importScripts` is not
...
The extension that is created consists of the extension's source code (a command
