...
The first thing we need is an application that we can run in a container. If
...
You'll also notice that the container configuration file we saw earlier has
