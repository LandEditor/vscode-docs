...
We convinced ourselves that what we needed was a way to run VS Code in two
...
For example, let's assume you are working on a deep learning project. You
...
3. Read the [Docs](https://aka.ms/vscode-remote). Try the
