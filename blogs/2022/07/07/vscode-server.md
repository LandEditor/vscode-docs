...
[GitHub Codespaces](https://code.visualstudio.com/docs/remote/codespaces), which
let you use VS Code locally or in a browser to develop applications on a remote
virtual machine that is hosted and managed in the cloud for you.
...
[vscode.dev](http://vscode.dev/)), without the hassle of setting up SSH or https
